...
func main() {
	...
	if err := ioutil.WriteFile("a.txt", out, 0644); err != nil {
		log.Fatalln("Failed to write address book:", err)
	}

	in, err := ioutil.ReadFile("a.txt")
	if err != nil {
...
func (Person_PhoneType) Descriptor() protoreflect.EnumDescriptor {
	return file_ex1_proto_enumTypes[0].Descriptor()
}

func (Person_PhoneType) Type() protoreflect.EnumType {
	return &file_ex1_proto_enumTypes[0]
}
...
func (Person_PhoneType) EnumDescriptor() ([]byte, []int) {
	return file_ex1_proto_rawDescGZIP(), []int{0, 0}
}
...
func (*Person) Descriptor() ([]byte, []int) {
	return file_ex1_proto_rawDescGZIP(), []int{0}
}
...
func (*AddressBook) Descriptor() ([]byte, []int) {
	return file_ex1_proto_rawDescGZIP(), []int{1}
}
...
var File_ex1_proto protoreflect.FileDescriptor

var file_ex1_proto_rawDesc = []byte{
	0x0a, 0x09, 0x65, 0x78, 0x31, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x74, 0x75, 0x74,
	0x6f, 0x72, 0x69, 0x61, 0x6c, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbb, 0x02, 0x0a, 0x06, 0x50, 0x65, 0x72, 0x73, 0x6f,
	...
	0x1a, 0x55, 0x0a, 0x0b, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12,
	0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x74, 0x75, 0x74, 0x6f, 0x72, 0x69, 0x61, 0x6c,
	...
	0x52, 0x4b, 0x10, 0x02, 0x22, 0x37, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42,
	...
	0x65, 0x72, 0x73, 0x6f, 0x6e, 0x52, 0x06, 0x70, 0x65, 0x6f, 0x70, 0x6c, 0x65, 0x42, 0x08, 0x5a,
	0x06, 0x2e, 0x2f, 0x6d, 0x61, 0x69, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_ex1_proto_rawDescOnce sync.Once
	file_ex1_proto_rawDescData = file_ex1_proto_rawDesc
)

func file_ex1_proto_rawDescGZIP() []byte {
	file_ex1_proto_rawDescOnce.Do(func() {
		file_ex1_proto_rawDescData = protoimpl.X.CompressGZIP(file_ex1_proto_rawDescData)
	})
	return file_ex1_proto_rawDescData
}

var file_ex1_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_ex1_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_ex1_proto_goTypes = []interface{}{
...
var file_ex1_proto_depIdxs = []int32{
...
func init() { file_ex1_proto_init() }
func file_ex1_proto_init() {
	if File_ex1_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ex1_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Person); i {
			case 0:
				return &v.state
			case 1:
		...
		file_ex1_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ex1_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ex1_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ex1_proto_goTypes,
		DependencyIndexes: file_ex1_proto_depIdxs,
		EnumInfos:         file_ex1_proto_enumTypes,
		MessageInfos:      file_ex1_proto_msgTypes,
	}.Build()
	File_ex1_proto = out.File
	file_ex1_proto_rawDesc = nil
	file_ex1_proto_goTypes = nil
	file_ex1_proto_depIdxs = nil
}
